    ...
    <>
      ...
      >
        <div className="w-full bg-[url('/images/particles/bg001-01.png')] bg-cover">
          <div id="welcome" className="w-full px-8 text-white h-[50vh] flex flex-col justify-center">
            <h1 className="text-5xl font-display font-bold text-blue">Heryan Djaruma</h1>
            <div className="flex flex-row mt-4">
              <button className="font-display px-9 py-.1 border-2 rounded-full border-blk text-blk">
                Works
              </button>
        ...
        <div id="work" className="bg-[url('/images/particles/bg003.png')] bg-fill flex flex-col py-6 px-4 w-full">
          <h1 className="font-display font-medium text-2xl text-blue">Works</h1>
          <Link href="/coder">
        ...
        <div id="background" className="bg-[url('/images/particles/bg000-01.png')] bg-fill flex flex-col py-6 px-4 w-full">
          <h1 className="font-display font-medium text-2xl text-blk mb-2">Education</h1>
          <ol className="relative border-l border-gray-200 dark:border-gray-700 font-display">                  
            ...
            <li className="mb-10 ml-4">
                <div className="absolute w-3 h-3 rounded-full mt-1.5 -left-1.5 border border-blk bg-blk"></div>
                <time className="mb-1 text-sm font-normal leading-none text-gray-400 italic">Undergraduate, 2021 - 2025</time>
